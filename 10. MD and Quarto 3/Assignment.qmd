...
```{python}
season_info = { 
     "season_number": 1, # We will try to make this dynmaic later
     "episodes": 10,     # You might need to adjust this
     "network": "HBO"    # You might 
     need to adjust this
 }

import pandas as pd
season_data_file = f"Data/season{season_info['season_number]']}.csv"
data = pd.read_csv(season_data_file)
print(data.head())
```
```{r}
load(paste0("../Data/season_",
params$season, ".RData"))
```
